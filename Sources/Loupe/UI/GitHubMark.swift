...
/// Das GitHub-Zeichen („Invertocat“) als Vorlage-Bild, damit es mit dem
/// Erscheinungsbild die Farbe wechselt. Faellt auf ein SF Symbol zurueck,
/// falls das System kein SVG laden kann.
enum GitHubMark {
    static let svg = """
    ...
    static func image() -> NSImage? {
        ...
        return NSImage(systemSymbolName: "chevron.left.forwardslash.chevron.right",
